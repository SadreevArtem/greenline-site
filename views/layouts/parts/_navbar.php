            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <!--                        						<div class="dropdown-item"><a href="/sales-markets/shipbuilding"--><?php //echo Yii::t('main', 'Судостроение') 
                                                                                                                                                ?><!--</a></div>-->
                        <!--                        						<div class="dropdown-item"><a href="/sales-markets/railways">--><?php //echo Yii::t('main', 'Железные дороги') 
                                                                                                                                            ?><!--</a></div>-->
                    </div>
                </li>
                ...
                <li class="nav-item"><?php echo Html::a(Yii::t('main', 'Склад'), ['/sales-markets/offshore-projects/warehouse'], ['class' => 'nav-link']) ?></li>
            </ul>
        </div>
