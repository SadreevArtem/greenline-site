...
$this->title = Yii::t('main', 'Greenline - ') . Yii::t('main', 'Проектирование, изготовление и поставка Выносных причальных устройств ВПУ');

$this->registerMetaTag([
    'name' => 'description',
    'content' => Yii::t('main', 'Greenline - ') . Yii::t('main', 'Производство и поставка ВПУ, Аренда ВПУ, Ведение проектов, поставка компонентов'),
]);
$this->registerMetaTag([
    'name' => 'keywords',
            ...
            <div class="row item-container d-block">
                        ...
                        [
                            ...
                            <div class="wr-cont flex-lg-row flex-column">
                                ...
                                <div class="wr-text px-4 px-lg-0">
                                    ...
                                    <div class="content">
                                        <p class="mb-0">' . Yii::t("main", "Одним из основных направлений Greenline Offshore & Marine является проектирование, сервисное обслуживание и поставка как полностью в сборе, так и поставка узлов и деталей для проведения ремонтов и замены ранее изношенных.") . '</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-12 py-lg-5">
                    <div class="row item-container align-items-center mb-lg-5 mb-0">
                        <div class="col-md-6 col-12 px-lg-0 pr-lg-5">
                            <div class="content wr-text">
                                <p>' . Yii::t("main", "Наша команда опытных инженеров и технических экспертов осуществляет строгий контроль качества, чтобы гарантировать соответствие наших продуктов и услуг самым высоким стандартам. С Greenline клиенты могут быть уверены, что получают продукты и услуги самого высокого качества в отрасли.") . '</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-12 px-lg-0 mb-4 mb-lg-0">
                            <div class="">
                ...
                <div class="col-12">
                    <div class="row item-container align-items-center mb-lg-5 mb-0">
                        <div class="col-md-6 col-12 px-lg-0 order-lg-1 pl-lg-5">
                            <div class="content wr-text">
                                <p>' . Yii::t("main", "Являясь ведущей инжиниринговой компанией в оффшорной отрасли, Greenline специализируется на проектировании, производстве и установке буевых терминалов, отвечающих самым высоким стандартам качества, безопасности и эффективности.") . '</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-12 px-lg-0 mb-4 mb-lg-0">
                            <div class="">
                ...
                <div class="col-12">
                    <div class="row item-container align-items-center mb-5">
                        <div class="col-md-6 col-12 px-lg-0 order-lg-1 pl-lg-5">
                            <div class="content wr-text">
                                <p>' . Yii::t("main", "Компания Greenline с момента своего основания сотрудничает со многими авторитетными международными компаниями, реализуя множество проектов в интересах крупных национальных компаний, в связи с чем за все время появилось множество партнерских отношений с ведущими производителями подобного оборудования в мире.") . '</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-12 px-lg-0 mb-4 mb-lg-0">
                            <div class="">
                ...
                <div class="wr-text mb-5 px-4 px-lg-0">
                    <p>' . Yii::t("main", "Greenline предоставляет комплексные услуги по поставкам, которые охватывают широкий спектр узлов и деталей ВПУ, а также их обвязки. Обладая глубокими знаниями и обширным опытом, Greenline стремится предоставлять материалы и услуги высочайшего качества по наиболее конкурентоспособной цене. Благодаря нашему опыту мы можем помочь заказчику с выбором оборудования по самой оптимальной цене и качеству. Служба закупок Greenline ориентирована не только на экономию средств заказчика, но и на обеспечение максимальной отдачи для компании в области оптимизации проектов. При этом учитываются такие факторы, как качество, надежность, скорость доставки и репутация поставщика.") . '</p>
                </div>
                <div class="col-12 mt-5">
                    <div class="row item-container align-items-center mb-0">
                        <div class="col-md-6 col-12 px-lg-0 pr-lg-5">
                            <div class="content wr-text">
                                <p>' . Yii::t("main", "Компания Greenline стремится стать ведущим поставщиком терминальных решений для морских операций по перевалке нефти. Мы стремимся помогать нашим клиентам в достижении их бизнес-целей благодаря нашему опыту, инновациям и стремлению к совершенству.") . '</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-12 px-lg-0 mb-4 mb-lg-0">
                            <div class="">
                        ...
                        [
                            ...
                            <div class="wr-text py-lg-5 px-4 px-lg-0">
                                <p>' . Yii::t("main", "Аренда ВПУ у компании Greenline убирает проблемы заказчиков связанные с сервисным обслуживанием ВПУ, т. к. оборудование меняется на новое в каждый период аренды.  Все поставляемое оборудование имеет сертификацию РМРС. Компания Greenline уделяет большое внимание качеству и надежности во всех своих услугах. Это обязательство гарантирует, что проекты выполняются в соответствии с самыми высокими стандартами. Срок производства ВПУ после согласования технической документации составляет 8 месяцев.") . '</p>
                            </div>
                            <div class="col-12 py-lg-5">
                                <div class="row item-container align-items-center mb-lg-5 mb-0">
                                    <div class="col-md-6 col-12 px-lg-0 pr-lg-5">
                                        <div class="content wr-text">
                                            <p>' . Yii::t("main", "Компания Greenline первая в мире переработала «классическую» конструкцию по изготовлению ВПУ и может предоставить заказчику доставку ВПУ с помощью автоперевозок в любой порт, где будет произведена финальная сборка. Данное предложение позволит заказчику убрать морскую перевозку и снизить ряд логистических затрат. Перевозка осуществляется с помощью обычных морских контейнеров и исключает необходимость привлекать спецтранспорт и наносить урон дорожному полотну.") . '</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 px-lg-0 mb-4 mb-lg-0">
                                        <div class="">
                        ...
                        [
                            ...
                            <div class="col-12 mb-lg-5 mt-lg-5">
                                <div class="row item-container align-items-center mb-lg-5 mb-0">
                                    ...
                                    <h3 class="h1 mb-4 font-weight-bold scaled-text">' . Yii::t("main", "Ведение проекта") . '</h3>
                                        <div class="content wr-text">
                                            <p>' . Yii::t("main", "Опираясь на помощь крупных партнёров, Компания Greenline осуществляет реализацию проекта в рамках единого консолидированного контракта, начиная с этапов проектирования и закупок и заканчивая строительством и передачей объекта в эксплуатацию.") . '</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 px-lg-0 mb-4 mb-lg-0">
                                        <div class="">
                            ...
                            <div class="wr-text py-lg-5 px-4 px-lg-0">
                                <p>' . Yii::t("main", "Пример основных этапов работы компании Greenline над проектами разработки, изготовления и поставок ВПУ:") . '</p>
                            </div>
                            <div class="col-12 py-lg-5">
                                <div class="row item-container align-items-center mb-lg-5 mb-0">
                                    <div class="col-md-6 col-12 px-lg-0 pr-lg-5">
                            ...
                            <div class="col-12 mb-lg-5">
                                <div class="row item-container align-items-center mb-lg-5 mb-0">
                                    ...
                                    <h3 class="h1 mb-4 font-weight-bold scaled-text">' . Yii::t("main", "Второй этап: Выделение отдельной команды для работы над проектом") . '</h3>
                                        <div class="content wr-text">
                                            <p>' . Yii::t("main", "После подписания договора и передачи проекта в Отдел по реализации проектов на каждый проект по изготовлению ВПУ выделяется отдельный ряд сотрудников, которые контролируют процесс изготовления 24/7. По согласованию с заказчиком возможно нахождения сотрудников Greenline непосредственно в офисе заказчика, для проведения более оперативной работы над проектом.") . '</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 px-lg-0 mb-4 mb-lg-0">
                                        <div class="">
                            ...
                            <div class="col-12 mb-lg-5">
                                <div class="row item-container align-items-center mb-lg-5 mb-0">
                                    ...
                                    <h3 class="h1 mb-4 font-weight-bold scaled-text">' . Yii::t("main", "Этап третий: Разработка конструкторской документации") . '</h3>
                                        <div class="content wr-text">
                                            <p>' . Yii::t("main", "Компания Greenline имеет в штате инженеров по проектированию систем ВПУ и имеет богатый опыт проектирования морских объектов. Для разработки новых узлов или обвязки ВПУ Greenline привлекает для работы партнерскую компанию со штатом более 200 конструкторов, имеющих огромный опыт в подобных проектах.") . '</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 px-lg-0 mb-4 mb-lg-0">
                                        <div class="">
                             ...
                             <div class="col-12 py-lg-5">
                                <div class="row item-container align-items-center mb-lg-5 mb-0">
                                    ...
                                    <h3 class="h1 mb-4 font-weight-bold scaled-text">' . Yii::t("main", "Этап седьмой: Закупка материалов") . '</h3>
                                        <div class="content wr-text">
                                            <p>' . Yii::t("main", "Для изготовления ВПУ компания Greenline производит закупку только высококачественных материалов, аудит поставщиков производится на ежегодной основе.") . '</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 px-lg-0 mb-4 mb-lg-0">
                                        <div class="">
                            ...
                            <div class="col-12 mb-lg-5">
                                <div class="row item-container align-items-center mb-lg-5 mb-0">
                                    ...
                                    <h3 class="h1 mb-4 font-weight-bold scaled-text">' . Yii::t("main", "Этап восьмой: Изготовление корпуса буя, поворотного стола, цепных стопоров") . '</h3>
                                        <div class="content wr-text">
                                            <p>' . Yii::t("main", "По согласованию с заказчиком, компания Greenline производит основные компоненты как на производстве в г. Санкт-Петербург или г. Калининград, так и Голландии или ОАЭ на высококвалифицированных вервях имеющих огромный опыт по изготовлению подобных конструкций.") . '</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 px-lg-0 mb-4 mb-lg-0">
                                        <div class="">
                            ...
                            <div class="col-12 py-lg-5">
                                <div class="row item-container align-items-center mb-lg-5 mb-0">
                                    ...
                                    <h3 class="h1 mb-4 font-weight-bold scaled-text">' . Yii::t("main", "Этап девятый: Покраска готовых деталей") . '</h3>
                                        <div class="content wr-text">
                                            <p>' . Yii::t("main", "Компания Greenline использует передовые лакокрасочные компоненты производства компании Hempel или Luton. Толщина покрытия грунтом и краской одинакова на всех поверхностях и соответствует согласованному Техническому Заданию.") . '</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 px-lg-0 mb-4 mb-lg-0">
                                        <div class="">
                            ...
                            <div class="col-12 py-lg-5">
                                <div class="row item-container align-items-center mb-lg-5 mb-0">
                                    <div class="col-md-6 col-12 px-lg-0 pr-lg-5">
                                        ...
                                        <div class="content wr-text">
                                            <p>' . Yii::t("main", "Транспортировка готовых изделий производится как силами заказчика, так и Отделом логистики компании Greenline, имеющей многолетний опыт отгрузок подобного оборудования по всему миру.") . '</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 px-lg-0 mb-4 mb-lg-0">
                                        <div class="">
                        ...
                        [
                            ...
                            <div class="col-12 py-lg-5">
                                <div class="row item-container align-items-center mb-lg-5 mb-0">
                                    <div class="col-md-6 col-12 px-lg-0 pr-lg-5">
                                        <div class="content wr-text">
                                            <p>' . Yii::t("main", "Благодаря нашей приверженности качеству, продукция наших партнеров не только соответствует стандартам, используемым в нашей отрасли, но и превосходит их, Greenline гордится тем, что является партнером производителей шлангов, который имеют сертификаты API Q1, API 17K, ISO 9001:2015 и оборудования, работающего под давлением с аккредитацией по директиве PED 2014/68/EU.") . '</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 px-lg-0 mb-4 mb-lg-0">
                                        <div class="">
                            ...
                            <div class="col-12 mb-lg-5 mt-lg-5">
                                <div class="row item-container align-items-center mb-lg-5 mb-0">
                                    ...
                                    <h3 class="h1 mb-4 font-weight-bold scaled-text">' . Yii::t("main", "Шаровые краны") . '</h3>
                                        <div class="content wr-text">
                                            <p>' . Yii::t("main", "Greenline поставляет Подводные шаровые краны по API 6DSS <br>&#8226; С одним или двумя шарами <br>&#8226; Боковой или верхний ввод <br>&#8226; В размерах От ½  до 64 <br>&#8226; Класс давления от 150 до API 6A 15.000") . '</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 px-lg-0 mb-4 mb-lg-0">
                                        <div class="">
                            ...
                            <div class="col-12 py-lg-5">
                                <div class="row item-container align-items-center mb-lg-5 mb-0">
                                    <div class="col-md-6 col-12 px-lg-0 pr-lg-5">
                                        ...
                                        <div class="content wr-text">
                                            <p>' . Yii::t("main", "Компания Greenline – единственная компания России, которая может производить шаровые краны по API 6DSS в России. Для каждого случая применения разрабатывается специальная конструкция, гарантирующая требуемый уровень производительности в течение всего прогнозируемого срока службы клапана.") . '</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 px-lg-0 mb-4 mb-lg-0">
                                        <div class="">
                            ...
                            <div class="col-12 mb-lg-5 mt-lg-5">
                                <div class="row item-container align-items-center mb-lg-5 mb-0">
                                    <div class="col-md-6 col-12 px-lg-0 order-lg-1 pl-lg-5 ">
                                        <div class="content wr-text">
                                            <p>' . Yii::t("main", "Эта модульная система также позволяет Greenline проводить статические и динамические заводские приемочные испытания системы уплотнения подшипников, в то время как остальные верхние и нижние узлы изготавливаются и подвергаются механической обработке, что сокращает время выполнения заказа и снижает риск. Это также обеспечивает большую гибкость при проектировании поворотных интерфейсов, поскольку Greenline предлагает одно-, двух- и трехканальные конструкции с каналами подачи жидкости диаметром от 16 дюймов и выше.") . '</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 px-lg-0 mb-4 mb-lg-0">
                                        <div class="">
                            ...
                            <div class="col-12 mb-lg-5 mt-lg-5">
                                <div class="row item-container align-items-center mb-lg-5 mb-0">
                                    ...
                                    <h3 class="h1 mb-4 font-weight-bold scaled-text">' . Yii::t("main", "Разрывная муфта и клапан рукава") . '</h3>
                                        <div class="content wr-text">
                                            <p>' . Yii::t("main", "Компания Greenline устанавливает на свои наливные системы лучшие клапаны рукава и разрывные муфты.") . '</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 px-lg-0 mb-4 mb-lg-0">
                                        <div class="">
