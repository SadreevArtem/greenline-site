...
$this->title = Yii::t('main', 'Greenline - ') . Yii::t('main', 'Инфраструктура');

$this->registerMetaTag([
	'name' => 'description',
	'content' => Yii::t('main', 'Greenline - ') . Yii::t('main', 'Инфраструктура'),
]);
$this->registerMetaTag([
	'name' => 'keywords',
		...
		<div class="row">
			<div class="col-lg-10 offset-lg-1 col-12">
				...
				<span class="breadcrumbs">
					...
					- <?php echo Html::a(Yii::t('main', 'Инфраструктура'), ['/sales-markets/infrastructure'], ['class' => 'current']) ?>
				</span>
			</div>
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="col-lg-10 offset-lg-1 col-12">
			<div class="row item-container">
				<div class="col-md-6 col-12">
					<div class="content">
						<p><?php echo Yii::t('main', 'У Greenline имеется обширный портфель передовых технологий по перекачке нефтепродуктов, системам управления, клапанам и различным услугам для нефтегазовой, горной, химической, энергетической отраслей, а также общего промышленного рынка. При необходимости мы можем привлекать международные EPC корпорации для реализации проектов любой сложности: ремонт зданий и сооружений; строительство «под ключ» дожимных компрессорных станций, станций налива жидких углеводородов, станций по компримированию и осушке газа.') ?></p>
					</div>
				</div>
				<div class="col-md-6 col-12">
					<div class="img-container">
