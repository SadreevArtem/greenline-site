...
$this->title = Yii::t('main', 'Greenline - ') . Yii::t('main', 'Производство электроэнергии');

$this->registerMetaTag([
	'name' => 'description',
	'content' => Yii::t('main', 'Greenline - ') . Yii::t('main', 'Производство электроэнергии'),
]);
$this->registerMetaTag([
	'name' => 'keywords',
