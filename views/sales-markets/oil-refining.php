...
$this->title = Yii::t('main', 'Greenline - ') . Yii::t('main', 'Нефтепереработка и транспортировка');

$this->registerMetaTag([
	'name' => 'description',
	'content' => Yii::t('main', 'Greenline - ') . Yii::t('main', 'Нефтепереработка и транспортировка'),
]);
$this->registerMetaTag([
	'name' => 'keywords',
	...
	<div class="row">
		...
		<div class="col-lg-10 offset-lg-1 col-12">
			<div class="row item-container">
				<div class="col-md-6 col-12">
					<div class="content">
						<p><?php echo Yii::t('main', 'Greenline постоянно совершенствуется и сотрудничает с ведущими лицензиарами мира в области поставки оборудования глубокой переработки нефти, а также имеет широкий список поставщиков оборудования для транспортировки газа. Мы как никто другой понимаем насколько важно поставлять передовое оборудование не только с точки зрения экологии, но и самое главное с точки зрения промышленной безопасности. Наше оборудование отвечает стандартам API.') ?></p>
					</div>
				</div>
				<div class="col-md-6 col-12">
					<div class="img-container">
