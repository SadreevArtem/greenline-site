...
$this->title = Yii::t('main', 'Greenline - ') . Yii::t('main', 'Космос и мобильные коммуникации');

$this->registerMetaTag([
	'name' => 'description',
	'content' => Yii::t('main', 'Greenline - ') . Yii::t('main', 'Космос и мобильные коммуникации')
]);
$this->registerMetaTag([
	'name' => 'keywords',
