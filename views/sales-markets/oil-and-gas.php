...
$this->title = Yii::t('main', 'Greenline - ') . Yii::t('main', 'Добыча нефти и газа');

$this->registerMetaTag([
	'name' => 'description',
	'content' => Yii::t('main', 'Greenline - ') . Yii::t('main', 'Добыча нефти и газа')
]);
$this->registerMetaTag([
	'name' => 'keywords',
