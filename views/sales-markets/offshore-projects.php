...
$this->title = Yii::t('main', 'Greenline - ') . Yii::t('main', 'Шельфовые проекты и морские порты - поставка нефтегазового оборудования для оффшорной добычи');

$this->registerMetaTag([
	'name' => 'description',
	'content' => Yii::t('main', 'Greenline - ') . Yii::t('main', 'Шельфовые проекты и морские порты - освоение месторождений континентального шельфа'),
]);
$this->registerMetaTag([
	'name' => 'keywords',
	...
	<div class="row">
		...
		<div class="col-lg-10 offset-lg-1 col-12">
			<div class="row item-container">
				...
				<div class="col-md-6 col-12">
					<div class="img-container">
						<img src="/img/sales-markets/platforms.jpg" alt="<?php echo Yii::t('main', 'Шельфовые проекты и морские порты') ?>">
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row item-container">
				<div class="col-md-6 col-12 order-md-2">
					...
					<div class="content">
						...
						<?php echo Html::a(Yii::t('main', 'Подробнее'), ['sales-markets/view', 'action' => 'offshore-projects', 'subaction' => 'stu'], ['class' => 'btn btn-success more-btn']) ?>
					</div>
				</div>
				<div class="col-md-6 col-12">
					<div class="img-container">
