...
$this->title = Yii::t('main', 'Greenline - ') . 'Partnership';

$this->registerMetaTag([
	'name' => 'description',
	'content' => Yii::t('main', 'Greenline - ') . 'Partnership',
]);
$this->registerMetaTag([
	'name' => 'keywords',
	'content' => 'Partnership',
...
<section id="principles" class="container">
	<div class="row">
		<div class="col-lg-10 offset-lg-1 col-12">
			<h2 class="up-line green">Greenline</h2>
			<div class="item">
				...
				<br>
				电话: <a href="tel:+74012994847">+7 (4012) 994 847</a>
			</div>
		</div>
	</div>
</section>