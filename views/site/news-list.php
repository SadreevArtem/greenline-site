		...
		<div class="col-lg-10 offset-lg-1 col-12">
			<div class="item">
				<div class="left">
					...
					<h2 class="title text-break"><?php echo Yii::t('main', 'Компания «Гринлайн» присоединилась к системе «Честный знак»') ?></h2>
					<div class="text text-justify"><?php echo Yii::t('main', 'Компания «Гринлайн» стала участником системы цифровой маркировки «Честный знак». Теперь наша продукция маркируется и отслеживается в полном соответствии с установленными требованиями. Это подтверждает нашу приверженность высоким стандартам качества, прозрачности и надежности для наших клиентов и партнеров.') ?></div>
					<?php echo Html::a(Yii::t('main', 'Подробнее'), ['/news/150526'], ['class' => 'btn btn-success more-btn']) ?>
				</div>
				<div class="right">
					<img src="/img/news/news_38.jpg" alt="<?php echo Yii::t('main', 'Компания «Гринлайн» присоединилась к системе «Честный знак»') ?>">
				</div>
			</div>
			<div class="item">
				<div class="left">
					<span class="time">16.03.2026</span>
					<h2 class="title text-break"><?php echo Yii::t('main', 'Компания «Гринлайн» приняла участие в Конгрессе NEFT 4.0 2026') ?></h2>
					<div class="text text-justify"><?php echo Yii::t('main', 'Компания «Гринлайн» приняла участие в Конгрессе NEFT 4.0 2026, который прошёл 16–17 марта в Санкт-Петербурге. В рамках мероприятия участники обсудили цифровизацию нефтегазовой отрасли, внедрение AI, вопросы технологической независимости, промышленной и кибербезопасности, а также современные цифровые решения для отрасли.') ?></div>
					<?php echo Html::a(Yii::t('main', 'Подробнее'), ['/news/160326'], ['class' => 'btn btn-success more-btn']) ?>
				</div>
				<div class="right">
					<img src="/img/news/news_40.jpg" alt="<?php echo Yii::t('main', 'Компания «Гринлайн» приняла участие в Конгрессе NEFT 4.0 2026') ?>">
				</div>
			</div>
			<div class="item">
				<div class="left">
