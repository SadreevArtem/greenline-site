...
$this->title = Yii::t('main', 'Greenline - ') . Yii::t('main', 'Наши бренды');

$this->registerMetaTag([
	'name' => 'description',
	'content' => Yii::t('main', 'Greenline - ') . Yii::t('main', 'Наши бренды'),
]);
$this->registerMetaTag([
	'name' => 'keywords',
		...
		<div class="row">
			<div class="col-lg-10 offset-lg-1 col-12">
				...
				<span class="breadcrumbs">
					...
					- <?php echo Html::a(Yii::t('main', 'Наши бренды'), ['/brands'], ['class' => 'current']) ?>
				</span>
			</div>
		</div>
	</div>
